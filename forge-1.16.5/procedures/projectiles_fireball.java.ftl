...
initProjectileProperties(new ${generator.map(field$projectile, "projectiles", 0)}(${generator.map(field$projectile, "projectiles", 1)}, projectileLevel), ${input$shooter}, new Vector3d(${input$ax}, ${input$ay}, ${input$az}))
</#if>
