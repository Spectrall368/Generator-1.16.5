...
@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD) public class ${name}GUISlotChangedMessage {

	private final int slotID, x, y, z, changeType, meta;

	public ${name}GUISlotChangedMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public ${name}GUISlotChangedMessage(PacketBuffer buffer) {
	...
	public static void buffer(${name}GUISlotChangedMessage message, PacketBuffer buffer) {
