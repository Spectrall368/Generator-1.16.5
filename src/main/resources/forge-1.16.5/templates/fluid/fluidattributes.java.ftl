...
public class ${name}FluidAttributes extends FluidAttributes {
	...
	@Override public int getColor(IBlockDisplayReader world, BlockPos pos) {
		return
		...
		<#elseif data.tintType == "Sky">
			Minecraft.getInstance().world.getBiome(pos).value().getSkyColor()
		<#elseif data.tintType == "Fog">
			Minecraft.getInstance().world.getBiome(pos).value().getFogColor()
		<#else>
